...
interface VendorConfirmOrderDialogProps {
  order: Order | null;
  isOpen: boolean;
  onClose: () => void;
...
export function VendorConfirmOrderDialog({
  order,
  isOpen,
  onClose,
  onConfirm,
  isLoading = false
}: VendorConfirmOrderDialogProps) {
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="bg-muted p-3 rounded-md">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h4 className="font-medium text-sm">Products ({order.items?.length || 0})</h4>
            </div>
