...
interface VendorComprehensiveProductViewProps {
  productId: string;
  product: any;
}

export function VendorComprehensiveProductView({ productId, product }: VendorComprehensiveProductViewProps) {
  ...
  const getTaxInfo = (taxId: string) => {
    ...
    if (!tax) return { name: taxId, rate: 0 };
